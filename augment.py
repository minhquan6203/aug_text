...
annotator = VnCoreNLP("./VnCoreNLP-1.1.1.jar", annotators="wseg, ner, pos", max_heap_size='-Xmx2g') 
import json
...
class LexicalReplacement():
    ...
    def augment(self, text):
        ...
        # return " ".join(s)
        for index in to_augment_index:
            pos_tag = all_word_annotated[index]['posTag']
            if pos_tag in ['N', 'A', 'V']:
                wordnet_dict = self.wordnet[pos_tag]
